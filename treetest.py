...
#                 if acc >= acc80:
#                     acc80 = acc
#                     saver.save(sess, "F:/Python/workshop/data/hydata/Pavia_org_1D2/simp-1.ckpt", global_step=step)
#                     # break
#             if acc > 0.9:
#                 if acc >= acc90:
#                     acc90 = acc
#                     saver.save(sess, "F:/Python/workshop/data/hydata/Pavia_org_1D2/simp-2.ckpt", global_step=step)
#                 high_acc_num += 1
#                 # if high_acc_num >=5:
#                 #      break
#
...
#                 #         in_index.append(a)
#             # print(in_index)
#             writeTiff(ttt, x_num, y_num, 1, 'F:/Python/workshop/data/hydata/Pavia_org_1D2/Pavia_org_simp.tif')
#         else:
#             ttt = label
